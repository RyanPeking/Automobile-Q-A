...
from Transformer_pgn import Transformer
from train_transformer_pgn import training
...
def train(params):
    ...
    batch_data = batcher(params["data_dir"], vocab, params)
    ...
    training(model, batch_data, params, ckpt, ckpt_manager)
...
def test(params):
    ...
    print("Creating the batcher ...")
    b = batcher(params["test_dir"], vocab, params)
