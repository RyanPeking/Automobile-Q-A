...
def main():
  ...
  parser.add_argument("--min_dec_steps", default=30, help="Minimum number of words of the predicted report", type=int)
  ...
  parser.add_argument("--mode", help="train, eval or test options", default="train", type=str)
