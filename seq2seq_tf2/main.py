...
def main():
  ...
  parser.add_argument("--batch_size", default=40, help="batch size", type=int)
  parser.add_argument("--beam_size", default=40, help="beam size for beam search decoding (must be equal to batch size in decode mode)", type=int)
  ...
  parser.add_argument("--max_num_to_eval", default=50, help="Max number of examples to evaluate", type=int)
